...
func NewDbTestConfig(dataBase string, connection string) *DbTestConfig {
	...
	ddlBefore[3] = "CREATE TABLE Accounts (Account_ID INTEGER auto_increment primary key, Document_Number varchar(100) NOT NULL, AvailableCreditLimit DOUBLE NOT NULL);"
	...
	ddlBefore[9] = "INSERT INTO Accounts (Document_Number, AvailableCreditLimit) VALUES ('123456',5000.0);"
